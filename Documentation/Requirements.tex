...
\begin{document}
	...
	\begin{table}[]
		...
		\label{my-label}
		\begin{tabular}{ll}
			GPS           & Global Positioning System. Used to determine a location on earth using satelite.                                     \\
			Accelerometer & An instrument for measuring the acceleration of a moving or vibrating body.                                          \\
			Heat map      & Visual dashboard that shows the concentration of subject of interest (pedestrian traffic) computed statistically.    \\
			Wi-Fi         & Wireless Fidelity. A form of wireless network communication.                                                         \\
			GUI           & Graphical User Interphase where a user can interact with the system by making inputs, searching and getting outputs.
		\end{tabular}
	\end{table}
